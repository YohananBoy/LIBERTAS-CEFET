...
export default function Home() {
  return (
    <main className="">
      <Header></Header>
      <section id="inicio" className="h-svh scroll-mt-37 bg-blue-50 p-10">
      ...
      <section id="pautas" className="h-svh scroll-mt-37 bg-blue-100 p-10">
      ...
      <section id="imagens" className="h-svh scroll-mt-37 bg-blue-200 p-10">
      ...
      <section id="junte-se" className="h-svh scroll-mt-37 bg-blue-300 p-10">
